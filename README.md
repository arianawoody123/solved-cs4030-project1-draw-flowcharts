Download Link: https://assignmentchef.com/product/solved-cs4030-project1-draw-flowcharts
<br>
Betore starting to code any of the problems, write pseudocode and/or draw flowcharts. Do not start coding until you have a deeper understanding of the solutions should look like. Write pseudocode from which you can directly code your program.
...
<ol start="2">
 ...
 <li>Convert from miles per gallon to liters per kilometer. The name of the Python code file will be FirstnameLastname_S 01_02.py.

  <ul>

   <li>Prompt the user to enter a figure for Miles per gallon.</li>

   <li>If the amount is &lt;= 0, exit the program.</li>

   <li>Convert miles to kilometers and gallons to liters. (Google the formulas.)</li>

   <li>From the previous step, calculate <u>iters</u> er Kilometer.</li>

   <li>Print the miles per gallon and lite pe meter with relevant messages, formatting your results to one decimal place.</li>
...
<h1>3. Print the color of a square on a chessboard. The name of the Python code file will be</h1>
